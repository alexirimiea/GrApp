...
import ro.almstar.domain.error.ErrorDetail;
import ro.almstar.domain.error.ValidationError;
...
//        }
        ...
        for (FieldError fieldError : fieldErrors) {
            ...
            if (validationErrorList == null) {
                ...
                errorDetail.getErrors().put(fieldError.getField(),
                        validationErrorList);
            }
            ValidationError validationError = new ValidationError();
            validationError.setCode(fieldError.getCode());
            String message = messageSource.getMessage("error."+ fieldError.getCode().toLowerCase(), null, fieldError.getDefaultMessage(), Locale.getDefault());
